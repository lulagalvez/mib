...
<div class="center">
    ...
    {:else if showReturnButton}
        ...
        <h1>
            ¡Felicidades! Has terminado de realizar el experimento 2 y los datos
    ...
    {:else}
        <!-- svelte-ignore a11y-missing-attribute -->
        <img src="/images/exp2_test.png" class="image-static" />
    {/if}
</div>
